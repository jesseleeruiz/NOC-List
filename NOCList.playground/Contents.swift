...
let allAgents = [agent1, agent2, agent3, agent4, agent5, agent6, agent7, agent8, agent9, agent10, agent11]
...
print("\(findCleanAgents().count) clean agents out of \(allAgents.count) total agents.")
...
func accessLevelOrder() {
    for agent in allAgents.sorted(by: {$0.accessLevel < $1.accessLevel}) {
        switch agent.accessLevel {
        case 1...4:
...
//            print("Cover Name:", agent.coverName, "Access Level:", agent.accessLevel)
//        } else if agent.accessLevel >= 5 && agent.accessLevel <= 7 {
//            print("Cover Name:", agent.coverName, "Access Level:", agent.accessLevel)
//        } else if agent.accessLevel >= 8 {
//            print("Cover Name:", agent.coverName, "Access Level:", agent.accessLevel)
//        }
